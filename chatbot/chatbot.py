...
def generate_plot_points(book_name, chapter_name, chapter_list):
    ...
    Returns:
    tuple: A tuple containing a PlotPoint object (or None if an error occurs) and the plot points data (or an error message).
    """
    page_content = find_chapter(book_name, chapter_name, chapter_list)
    print(f"Extracted content for {chapter_name}: {page_content[:200]}...")

    if page_content == "Chapter not found":
    ...
    print(f"Plot points response: {plot_points_response[:200]}...")
    ...
    print(f"Parsed plot points data: {plot_points_data}")
    ...
    print("Plot points generated and parsed successfully.")
